    ...
    <div className="container mx-auto max-w-4xl px-4 py-12 md:py-20">
      <Card>
        ...
        <CardContent className="prose prose-sm sm:prose lg:prose-lg dark:prose-invert max-w-none space-y-4">
          <p>
            SocialTrendRadar ("us", "we", or "our") operates the [Your Website URL] website (the "Service").
          </p>
          ...
          <p>
            ...
            and Conditions, accessible from [Your Website URL]/terms.
          </p>
          ...
          <ul>
            ...
            <li>Cookies and Usage Data</li>
             <li>Selected content niches</li>
             <li>Payment Information (handled by Stripe, we do not store full credit card numbers)</li>
          </ul>
          ...
          <h2>Use of Data</h2>
          <p>SocialTrendRadar uses the collected data for various purposes:</p>
          <ul>
            ...
            <li>To detect, prevent and address technical issues</li>
             <li>To personalize trend alerts and content suggestions</li>
          ...
          <p>
            SocialTrendRadar may disclose your Personal Data in the good faith belief that such action is
            necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of SocialTrendRadar</li>
          ...
          <p>
           ...
           <h2>Service Providers</h2>
            ...
            <p>
              These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose. Examples include Google Cloud (for AI processing) and Stripe (for payment processing).
            </p>
